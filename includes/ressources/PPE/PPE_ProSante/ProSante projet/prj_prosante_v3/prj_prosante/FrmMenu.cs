    ...
    public partial class FrmMenu : Form
    {
        ...
        private void OpenFile(object sender, EventArgs e)
        {
            ...
            while (maLigne.Read())
            {
                ...
                int note = int.Parse(valeurColonnes[7]);
                string duree = valeurColonnes[8];
                ...
                visite uneVisite = new visite(dateVisite, nbProdRet, nbProdPres, leProfessionnel, leVisiteur, note, duree);
        ...
        {
            FrmProfessionnelListeVille maFenetre = new FrmProfessionnelListeVille();
            maFenetre.MdiParent = this;
            maFenetre.Show();
        }
